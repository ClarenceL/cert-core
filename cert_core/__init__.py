...
CHAIN_ELASTOS_MAINNET = 'elastosMainnet'
CHAIN_ELASTOS_TESTNET = 'elastosTestnet'
...
SYS_CHAIN_ELASTOS_MAINNET = 'elastos_mainnet'
SYS_CHAIN_ELASTOS_TESTNET = 'elastos_testnet'
...
class Chain(Enum):
    ...
    elastos_mainnet = 6, BlockchainType.ethereum, CHAIN_ELASTOS_MAINNET
    elastos_testnet = 7, BlockchainType.ethereum, CHAIN_ELASTOS_TESTNET
    ...
    def parse_from_chain(chain_string):
        ...
        elif chain_string == SYS_CHAIN_ELASTOS_MAINNET:
            return Chain.elastos_mainnet
        elif chain_string == SYS_CHAIN_ELASTOS_TESTNET:
            return Chain.elastos_testnet
        else:
    ...
    def parse_from_external_display_value(external_display_value):
        if external_display_value == CHAIN_BITCOIN_MAINNET:
            ...
            return Chain.ethereum_ropsten
        elif external_display_value == CHAIN_ELASTOS_MAINNET:
            return Chain.elastos_mainnet
        elif external_display_value == CHAIN_ELASTOS_TESTNET:
            return Chain.elastos_testnet
        else:
